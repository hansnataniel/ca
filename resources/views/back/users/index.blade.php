...
@section('search')
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				{!!Form::label('src_usergroup_id', 'User Group', ['class'=>'menu-search-label'])!!}	
				{!!Form::select('src_usergroup_id', $usergroup_options, null, ['class'=>'menu-search-text select'])!!}
			</div>
			<div class="menu-search-group">
											...
											<li>
												<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/user/suspended/' . $user->id)}}" class="separator">
													@if($user->is_suspended == true)
														{!!HTML::image('img/admin/index/unsuspended_icon.png')!!}
														<span>
															Unsuspended
														</span>
													@else
														{!!HTML::image('img/admin/index/suspended_icon.png')!!}
														<span>
															Suspended
														</span>
													@endif
