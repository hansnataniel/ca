	...
	<script type="text/javascript">
		$(function(){
			$('.edit-form-image-delete').click(function(){
		    	...
		    	$.ajax({
		    		type: 'GET',
		    		url: "{{URL::to(Crypt::decrypt($setting->admin_url) . '/gallery-category/delete-image')}}/"+value,
...
@section('page_title')
	Gallery Category Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/gallery-category')}}">Gallery Category</a> / <span>Gallery Category Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($gallerycategory, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/gallery-category/' . $gallerycategory->id), 'method' => 'PUT', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-1">
