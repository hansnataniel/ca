			...
			<div class="page-item-content">				
				...
				<div class="page-group">
					<div class="page-item col-1">
						...
						<div class="page-item-content edit-item-content">
							<div class="edit-form-group">
								{!!Form::label('coordinat', 'Coordinat', ['class'=>'edit-form-label'])!!}
								...
								<div class="edit-form-note-custom">
									*Click on the map to change the coordinate<br>
									*Type address on <i>Search Box</i> to change coordinate instantly
								</div>
							</div>
							<div class="edit-form-group">
				...
				<div class="edit-last-edit">
					<?php
						$updateuser = Admin::find($setting->settingupdated_by);
					?>
