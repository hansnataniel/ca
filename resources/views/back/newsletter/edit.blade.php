...
@section('page_title')
	Newsletter Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter')}}">Newsletter</a> / <span>Newsletter Edit</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($newsletter, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/' . $newsletter->id), 'method' => 'PUT', 'files' => true, 'class'=>'formactive'])!!}
					<div class="page-group">
						<div class="page-item col-1">
