...
@section('page_title')
	Newsletter
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <span>Newsletter</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		...
		<li>
			Gunakan tombol View di dalam tombol Action untuk melihat detail dari Newsletter
		</li>
		<li>
			Gunakan tombol Edit di dalam tombol Action untuk mengedit Newsletter
		</li>
		<li>
			Gunakan tombol Delete di dalam tombol Action untuk menghapus Newsletter
		</li>
		<li>
			Gunakan tombol Broadcast di dalam tombol Action untuk membroadcast newsletter
		</li>
	</ul>
@endsection
...
@section('search')
	{!!Form::open(['URL' => URL::current(), 'method' => 'GET'])!!}
		<div class="menu-group">
			...
			<div class="menu-search-group">
				{!!Form::label('src_is_sent', 'Broadcast Status', ['class'=>'menu-search-label'])!!}	
				{!!Form::select('src_is_sent', [''=>'Select Broadcast Status', '1'=>'Broadcasted', '0'=>'Not Broadcast'], null, ['class'=>'menu-search-text select'])!!}
			</div>
			<div class="menu-search-group">
		...
		<div class="page-item col-1">
			<div class="page-item-content">
				<div class="index-desc-container">
					<a class="index-desc-item" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/create')}}">
				...
				<table class="index-table">
					...
					@foreach ($newsletters as $newsletter)
						...
						<tr>
							...
							<td>
								{!!$newsletter->is_sent == true ? "<span class='text-green'>Broadcasted</span>":"<span class='text-red'>Not Broadcast</span>"!!}
							</td>
							<td>
								{!!$newsletter->is_active == true ? "<span class='text-green'>Active</span>":"<span class='text-red'>Not Active</span>"!!}
							</td>
							<td class="index-td-icon">
								<div class="index-action-switch">
									...
									<ul class="index-action-child-container" style="width: 200px">
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/broadcast/' . $newsletter->id)}}" class="separator">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/' . $newsletter->id)}}">
										...
										<li>
											<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/' . $newsletter->id . '/edit')}}">
									...
									<div class="index-del-content">
										...
										{!!Form::open(['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/newsletter/' . $newsletter->id), 'method' => 'DELETE', 'class'=>'form index-del-item'])!!}
				...
				{{-- 
					Pagination
				 --}}
				{{$newsletters->appends($criteria)->links('vendor.pagination.default')}}
			</div>
		</div>
	</div>
@endsection