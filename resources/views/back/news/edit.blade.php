	...
	<script type="text/javascript">
		$(function(){
			$('.edit-form-image-delete').click(function(){
		    	...
		    	$.ajax({
		    		type: 'GET',
		    		url: "{{URL::to(Crypt::decrypt($setting->admin_url) . '/news/delete-image')}}/"+value,
...
@section('page_title')
	News Edit
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/news')}}">News</a> / <span>News Edit</span>
	</span>
@endsection
...
@section('help')
	<ul class="menu-help-list-container">
		<li>
			Field <i>Short Description</i> digunakan untuk mendeskripsikan sekilas tentang news dan akan ditampilkan di halaman list news
		</li>
		<li>
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				@else
					<a class="edit-button-item edit-button-back" href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/news')}}">
						Back
					</a>
				@endif
				...
				{!!Form::model($news, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/news/' . $news->id), 'method' => 'PUT', 'files' => true])!!}
					<div class="page-group">
						<div class="page-item col-2-4">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									...
									{!!Form::text('title', null, ['class'=>'edit-form-text large', 'required'])!!}
								...
								<div class="edit-form-group">
									...
									{!!Form::textarea('short_description', $news->short_desc, ['class'=>'edit-form-text large area', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
								<div class="edit-form-group">
									...
									@if (file_exists(public_path() . '/usr/img/news/' . $news->id . '_' . Str::slug($news->title, '_') . '_thumb.jpg'))
										<div class="edit-form-image">
											{!!HTML::image('usr/img/news/' . $news->id . '_' . Str::slug($news->title, '_') . '_thumb.jpg?lastmod=' . Str::random(5))!!}
											{!!Form::button('Delete Image', ['class'=>'edit-form-image-delete', 'value'=>$news->id . '_' . Str::slug($news->title, '_')])!!}
						...
						<div class="page-item col-2-4">
							...
							<div class="page-item-content edit-item-content">
								<div class="edit-form-group">
									...
									{!!Form::textarea('meta_description', $news->meta_desc, ['class'=>'edit-form-text large area', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
								<div class="edit-form-group">
									...
									{!!Form::textarea('meta_keyword', $news->meta_key, ['class'=>'edit-form-text large area', 'required'])!!}
									<span class="edit-form-note">
										*Required
									</span>
								</div>
