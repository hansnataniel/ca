...
@section('page_title')
	New News
	<span>
		<a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/dashboard')}}">Dashboard</a> / <a href="{{URL::to(Crypt::decrypt($setting->admin_url) . '/news')}}">News</a> / <span>New News</span>
	</span>
@endsection
	...
	<div class="page-group">
		<div class="page-item col-1">
			<div class="page-item-content">
				...
				{!!Form::model($news, ['url' => URL::to(Crypt::decrypt($setting->admin_url) . '/news'), 'method' => 'POST', 'files' => true])!!}
					<div class="page-group">
